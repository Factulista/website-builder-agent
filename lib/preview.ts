...
function ensureMobileNav(html: string, megaPages: MegaPage[]): string {
  ...
  if (!/data-mm-toggle/.test(html)) {
    ...
    const css = `<style data-mm-css="1">.mobile-menu .btn-accent-nav{color:#fff !important;}.mobile-menu .btn-ghost-nav{color:#111 !important;}.mobile-menu{-webkit-overflow-scrolling:touch;overscroll-behavior:contain;}html.mm-lock{overflow:hidden;height:100%;}html.mm-lock body{overflow:hidden;height:100%;}</style>`
