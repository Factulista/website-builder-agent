...
export async function GET(req: NextRequest) {
  ...
  const { data: posts, error } = await supabase
    .from('blog_posts')
    .select('id, title, slug, excerpt, featured_image, status, published_at, scheduled_at, categories, tags, author, created_at, updated_at, seo_title, seo_description, content_html')
